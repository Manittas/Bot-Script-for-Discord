...
Both the script and *'.env'* file need to be in the same folder. The *'.env'* file in this repository has no real values, instead it serves as an example of how it should look.
